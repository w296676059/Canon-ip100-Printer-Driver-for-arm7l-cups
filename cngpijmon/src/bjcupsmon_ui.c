...
PRIVATE const gchar	*gSTSMessageTable[] = {
	...
	N_("\nUse only one ink tank per color at a time.\n"),
	...
	N_("Remove the loaded paper in the front tray and close the front cover. Keep the document cover open.\n"),
...
PRIVATE const gchar	*gOtherMessageTable[] = {
	...
	/* ID_OTHER_MESSAGE_SLEEP */
	N_("Printer is standing by.\n"),
	/* ID_OTHER_MESSAGE_BUSY */
	N_("Printer is busy.\n"),
	/* ID_OTHER_MESSAGE_FIRMUP */
	N_("The printer is updating the firmware.\nTurn the printer off and then on again.\nIf this message appears again, update the firmware once more.\n"),
	...
	"  cngpijmon(2.90.01.012) : argument error.\n  Usage: cngpijmon****** [printer name]\n\n   ex) cngpijmonmx890 MX890\n\n",
};
