...
static const SpinScaleTable spin_scale_table[] =
{
	...
	{ "color_dialog_tone_scale2", "c_dlg_tone_value_spin2"}, /* Ver.3.40 */
};
...
//	"color_dialog_balance_label2",	//Ver.3.10
...
static const char* bw_sensitive_name_black_adjustment[] =
{
	"color_dialog_tone_label2",
	"c_dlg_tone_value_spin2",
	"c_dlg_tone_cool_xpm2",
	"color_dialog_tone_scale2",
	"c_dlg_tone_warm_xpm2",
	"color_dialog_tone_cool2",
	"color_dialog_tone_warm2",
	NULL,
};
...
on_color_dialog_tone_scale2_value_changed
                                        ...
                                        gpointer         user_data)
{
	C_DLG_ScaleValueChanged( range , TONE_DLG_ID );
}
...
on_c_dlg_tone_value_spin2_value_changed
                                        ...
                                        gpointer         user_data)
{
	C_DLG_SpinValueChanged( spinbutton , TONE_DLG_ID );
}
